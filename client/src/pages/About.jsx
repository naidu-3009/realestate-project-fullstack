  ...
  return (
    <div className=" py-10 px-4 max-w-6xl mx-auto">
      ...
      <p className="mb-5 text-slate-700 font-semibold">
        ...
        just for you. Our platform is designed to make finding your dream home
        or showcasing your property as easy and efficient as possible. With a
      ...
      <p className="mb-5 text-slate-700 font-semibold">
        ...
        you’re a homeowner wanting to list your property or a tenant searching
        for the perfect place to call home, our robust set of tools and
        resources are here to guide you every step of the way. We are committed
      ...
      <p className="mb-5 text-slate-700 font-semibold">
        ...
        is not just a marketplace; its a community where buyers, sellers,
